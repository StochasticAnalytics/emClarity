function [] = BH_refine_on_beads(baseName,NX,NY,thickness,pixelSize,bead_diameter)
...
for imageBinning = [15:-2:5]
  ...
  'tilt ' ...
    ...
    '-SHIFT 0.0 0.0 ' ...
    '-PERPENDICULAR ' ...
    '-FULLIMAGE %d,%d %s '],output_name,output_name,input_name,...
                        input_name,imageBinning,thickness,...
                        xTiltOption,NX,NY,z_factor_file));
  ...
  'tilt ' ...
    ...
    '-FULLIMAGE %d,%d ' ...
    '-PERPENDICULAR  ' ...
    '-MODE 2 %s '], output_name,output_name,imageBinning,...
                input_name,input_name,thickness,...
                xTiltOption,output_name,NX,NY,z_factor_file));
  ...
  BH_fitBeads(pixelSize,bead_diameter,imageBinning,...
  ...
  'tiltalign ' ...
    ...
    '-AngleOffset 0.0 > tiltAlign_%s.log'],...
    ...
    x_tilt_option(3:4), x_stretch_option(3:4),output_name));
