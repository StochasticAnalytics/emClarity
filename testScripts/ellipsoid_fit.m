...
if length( x ) < 9
    switch length(x)
        case 8
            fprintf('WARNING: Only 8 subTomos, reducing fit to a unique ellipsoid with two equal radii\n');
            equals = 'xy';
        case 7
            fprintf('WARNING: Only 7 subTomos, reducing fit to a unique oriented ellipsoid\n');
            equals = '0';
        case 6
            fprintf('WARNING: Only 6 subTomos, reducing fit to a unique oriented ellipsoid\n');
            equals = '0';
        case 5
            fprintf('WARNING: Only 5 subTomos, reducing fit to a unique oriented ellipsoid with two equal radii\n');
            equals = '0xy';
        case 4
            fprintf('WARNING: Only 4 subTomos, reducing fit to a unique  unique sphere\n');
            equals = 'xyz';
        otherwise
            error('There are less than 4 points, no fitting is possible!');
    end
end
...
d = [ x - center(1), y - center(2), z - center(3) ];
