...
%% 2d
imgSizes = help_getRandomSizes(2, [80, 1000], '2d');
...
%% 3d
imgSizes = help_getRandomSizes(2, [80, 250], '3d');
img = help_getBatch({'fixtureOnes'}, {'cpu'; 'gpu'}, {'single'; 'double'}, imgSizes);
...
limits = help_getRandomLimits(3, [-30,30], {'both'}, {'all',}, {'both'}, '2d');
...
%% 3d
imgSizes = help_getRandomSizes(2, [80, 200], '3d');
img = help_getBatch({'fixtureOnes'}, {'cpu'; 'gpu'}, {'single'; 'double'}, imgSizes);

limits = help_getRandomLimits(3, [-30,30], {'both'}, {'all',}, {'both'}, '3d');
...
option = help_getBatchOption({'precision', {1; 1.4; 'kayak'; []; [1,2,3]; {}}});
option = option(~cellfun(@isempty, option));
testCase.TestData.toTest = help_getBatch(img, limits, option, {'EMC_resize:precision'}, {false});
...
option = option(~cellfun(@isempty, option));
testCase.TestData.toTest = help_getBatch(img, limits, option, {'EMC_resize:taper'}, {false});

% EMC_taper:SIZE
option = help_getBatchOption({'taper', {{'cosine', 1}; {'cosine', -1}; {'linear', 1}; {'linear', -1}}});
option = option(~cellfun(@isempty, option));
testCase.TestData.toTest = [testCase.TestData.toTest; ...
                            help_getBatch(img, limits, option, {'EMC_taper:SIZE'}, {false})];

% EMC_taper:TYPE
option = help_getBatchOption({'taper', {{'kayak', 10}; {[], 10}}});
option = option(~cellfun(@isempty, option));
testCase.TestData.toTest = [testCase.TestData.toTest; ...
                            help_getBatch(img, limits, option, {'EMC_taper:TYPE'}, {false})];
                        
% EMC_resize:inputImageTooSmall
img1 = {'fixtureOnes', 'cpu', 'single', [100,100]};
img2 = {'fixtureOnes', 'cpu', 'single', [100,101]};

testCase.TestData.toTest = [testCase.TestData.toTest; { ...
    img1, [10,10,10,10], {'taper', {'linear', 101}}, 'EMC_resize:inputImageTooSmall', false; ...
    img2, [10,10,10,10], {'taper', {'linear', 102}}, 'EMC_resize:inputImageTooSmall', false; ...
    img2, [10,10,10,10], {'taper', {'linear', 51}; 'origin', -1}, 'EMC_resize:inputImageTooSmall', false; ...
    }];
...
option = option(~cellfun(@isempty, option));
testCase.TestData.toTest = [testCase.TestData.toTest; ...
                            help_getBatch(img, limits, option, {'EMC_resize:value'}, {false})];
...
testCase.TestData.toTest = { ...
    ...
    img, [5,5,5,5], {'origin', 0},                      'EMC_resize:origin',    false; ...
    img, [5,5,5,5], {'origin', 3},                      'EMC_resize:origin',    false; ...
    img, [5,5,5,5], {'origin', 1.2},                    'EMC_resize:origin',    false; ...
    img, [5,5,5,5], {'origin', 'kayak'},                'EMC_resize:origin',    false; ...

    % force taper should be a bool
    img, [5,5,5,5], {'force_taper', 3},                 'EMC_resize:force_taper',   false; ...
    img, [5,5,5,5], {'force_taper', 1.2},               'EMC_resize:force_taper',   false; ...
    img, [5,5,5,5], {'force_taper', 'kayak'},           'EMC_resize:force_taper',   false; ...
    img, [5,5,5,5], {'force_taper', [true, false]'},    'EMC_resize:force_taper',   false; ...

    % Img should be 2d or 3d numerical array
    ones(1,10),         [5,5,5,5], {},                 	'EMC_resize:inputImage',    false; ...
    10,                 [5,5,5,5], {},                 	'EMC_resize:inputImage',    false; ...
    'kayak',            [5,5,5,5], {},                 	'EMC_resize:inputImage',    false; ...
    {},                 [5,5,5,5], {},                  'EMC_resize:inputImage',   	false; ...
    1:-1,               [5,5,5,5], {},                  'EMC_resize:inputImage',   	false; ...
    
    [],                 [5,5,5,5], {},                  'EMC_is3d:SIZE',            false; ...
    ones(10,10,10,10),  [5,5,5,5], {},                  'EMC_is3d:SIZE',            false; ...
    
    % limits should be a numerical vector of size=ndim*2
    ones(20,20,20), [5,5,5,5], {},                      'EMC_resize:ndimNotRecognized', false; ...;
    img, [5,5;5,5;5,5], {},                             'EMC_resize:ndimNotRecognized', false; ...
    img, [5,5,5,5,5],   {},                             'EMC_resize:ndimNotRecognized', false; ...
    img, [5,5],         {},                             'EMC_resize:ndimNotRecognized', false; ...
    img, [5,5;5,5],     {},                             'EMC_resize:ndimNotRecognized', false; ...
    img, 5,             {},                             'EMC_resize:ndimNotRecognized', false; ...
    img, 'kayak',       {},                             'EMC_resize:ndimNotRecognized', false; ...
    img, [],            {},                             'EMC_resize:ndimNotRecognized', false; ...
    img, {},            {},                             'EMC_resize:ndimNotRecognized', false; ...
};
