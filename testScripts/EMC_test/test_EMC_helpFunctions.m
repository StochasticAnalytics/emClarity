...
testCase.TestData.toTest = { ...
    ones(100,100, 'single'),               false, {'single', 'cpu'}; ...
    ones(100,100, 'double'),               false, {'double', 'cpu'}; ...
    ones(100,100, 'int8'),                 false, {'int8', 'cpu'}; ...
    ones(100,100, 'int16'),                false, {'int16', 'cpu'}; ...
    ones(100,100, 'int32'),                false, {'int32', 'cpu'}; ...
    ones(100,100, 'uint32'),               false, {'uint32', 'cpu'}; ...
    ones(100,100),                         false, {'double', 'cpu'}; ...
    
    gpuArray(ones(100,100, 'single')),     false, {'single', 'gpu'}; ...
    gpuArray(ones(100,100, 'double')),     false, {'double', 'gpu'}; ...
    gpuArray(ones(100,100, 'int8')),       false, {'int8', 'gpu'}; ...
    gpuArray(ones(100,100, 'int16')),      false, {'int16', 'gpu'}; ...
    gpuArray(ones(00,100, 'int32')),       false, {'int32', 'gpu'}; ...
    gpuArray(ones(100,100, 'uint32')),     false, {'uint32', 'gpu'}; ...
    gpuArray(ones(100,100)),               false, {'double', 'gpu'}; ...
...
testCase.TestData.debug = 0;
testCase.TestData.testName = '';
testCase.TestData.fixtureImg = @help_getInputOnes;

img = help_getBatch({'fixtureImg'}, {'single'; 'double'}, ...
    {'single';'double';'int16';'int32';'int64';'uint16';'uint32';'uint64';'logical'}, {[10,10]});

precisions = {'single';'double';'int16';'int32';'int64';'uint16';'uint32';'uint64';'logical'};
expectedError = {false};
extra = {false};

testCase.TestData.toTest = help_getBatch(img, precisions, expectedError, extra);
EMC_runTest(testCase);
